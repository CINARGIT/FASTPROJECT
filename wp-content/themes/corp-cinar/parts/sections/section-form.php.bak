	...
	<div class="container">
		...
		<div class="quote_box">
			...
			<div class="quote_info">
				<div class="quote_info_data">
					<div class="quote_info_name">
						<?=$form1['avtor']?>
					</div>
					<div class="quote_info_dolzhnost">
						<?=$form1['dolzhnost']?>
					</div>
				</div>
				<div class="quote_info_photo">
					<img src="<?=$form1['foto_avtora']['url']?>" alt="<?=$form1['avtor']?>">
				</div>
			</div>
		</div>
	</div>
