...
<div class="section-common section-contact">
	<div class="container">
		<h2><?=highlightLastWord(get_the_title())?></h2>
		
		<div class="row">
				<div class="col-xs-12 col-md-6 sct-left">
				<div class="sct-box">
					<div class="row">
					<div class="scm_item col-xs-12 col-md-6">
						<div class="scm_item_box_in">
							<div class="scm_item_label">Наши телефоны</div>
							<div class="scm_item_val"><a href="tel:<?=get_field('phone', 'option')?>"><?=get_field('phone', 'option')?></a></div>
							<div class="scm_item_val"><a href="tel:<?=get_field('phone', 'option')?>"><?=get_field('phone2', 'option')?></a></div>
						</div>
					</div>
					<div class="scm_item col-xs-12 col-md-6">
						<div class="scm_item_box_in">
							<div class="scm_item_label">Электронная почта</div>
							<div class="scm_item_val"><a href="mailto:<?=get_field('mail', 'option')?>"><?=get_field('mail', 'option')?></a></div>
						</div>
					</div>
					</div>
					...
					<div class="scm_item_box_in">
						...
						<div class="scm_item_val scm_item_val_mini"><?=get_field('address', 'option')?></div>
						<div class="scm_item_val scm_item_val_mini"><strong><?=get_field('opening_hours', 'option')?></strong></div>
					</div>
					</div>
					
					<div class="scm_open_content">Смотреть реквизиты</div>
					<div class="scm_hidden_content"><?=get_field('rekvezity', 'option')?></div>
