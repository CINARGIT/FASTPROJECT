...
<div class="row row_footer">
	<div class="col-xs-12 col-md-4 foot_privacy foot_des_left">
		<a class="privacy-policy-link" href="/politika-konfidentsialnosti/" rel="privacy-policy">Политика конфиденциальности</a>
	</div>
	<div class="col-xs-12 col-md-4 foot_des_center">
        © <?=date('Y')?> <?=$footerGroup['deskriptor_v_podvale']?>
	</div>
	<div class="col-xs-12 col-md-4 cinar-text-right">
	<div class="cinar">
		<a href="https://cinar.ru" target="_blank">
			<img src="<?=get_template_directory_uri()?>/img/cinar.svg" alt="Cinar - создание и продвижение сайтов">
