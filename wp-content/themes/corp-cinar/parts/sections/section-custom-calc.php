...
<div class="calc_wrap container" id="calc_wrap">
	<form class="calc_form">
		<div class="step_wrap step-1 active">
			<div class="calc_subzag"><span>01. Размеры здания</span></div>
			<div class="calc_subwrap calc_subwrap_margin">
			...
			<div class="calc_subzag"><span>02. Параметры здания</span></div>
		...
		<div class="step_wrap step-2">
			<div class="calc_subzag"><span>3. Виды работ</span></div>
			<div class="calc_subwrap_wrap">
			<div class="calc_subwrap">
				<div class="calc_itemwrap">
					<div class="calc_itemzag"><span>Обследование</span></div>
				...
				<div class="calc_itemwrap">
					<div class="calc_itemzag"><span>Обмерные работы</span></div>
				...
				<div class="calc_itemwrap">
					<div class="calc_itemzag"><span>Обследование инженерных систем</span></div>
		...
		<div class="calc_subwrap_wrap">
			<div class="calc_subzag"><span>4. Дополнительные параметры</span></div>
			<div class="calc_subwrap">
				<div class="calc_itemwrap">
				...
				<div class="calc_itemwrap">
					...
					<div class="pseudoche liketxt" data-val="1.25">Шаг конструкций менее 6 метров</div>
					<div class="pseudoche liketxt" data-val="1.1">Смета на ремонтно-восстановительные работы</div>
					<input type="hidden" name="profac" value="1">
				</div>
				<div class="calc_itemwrap">
					<div class="pseudoche liketxt jekyll">Требуется автоподъёмник</div>
					<input type="text" name="avtopod" placeholder="Укажите количество дней">
				</div>
				<div class="calc_itemwrap">
					<div class="pseudoche liketxt jekyll">Требуется откопка шурфов</div>
					<input type="text" name="otschur" placeholder="Укажите количество шурфов">
				</div>
				<div class="calc_itemwrap calc_itemwrap_mfix">
				...
				<div class="calc_itemwrap calc_itemwrap_mfix">
					<div class="calc_itemzag"><span>Коэффициент инфляции</span></div>
					<span class="mini_subdescription">На I квартал 2023 года согласно Письму Минстроя России № 39010-ИФ/09 от 05.08.2022</span>
		...
		<div class="calc_subwrap_wrap">
			...
			<div class="calc_subzag forhide"><span>5. Ваши контактные данные</span></div>
			<div class="calc_subwrap forhide">
				...
				<div class="calc_itemwrap">
					...
					<input type="text" class="idphone" name="phone" placeholder="Введите телефон">
				</div>
				<div class="calc_itemwrap">
		...
		<div class="calc_resul">
			<div class="calc_prev order_button style_3" data-next="1">Назад</div>
			<div class="calc_next order_button" data-next="2">Вперёд</div>
		</div>
		
		
			<div class="calc_subwrap forques">
				<div id="calc_info_1" class="infomodal">
				...
				<div id="calc_info_2" class="infomodal">
