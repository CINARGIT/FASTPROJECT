...
$achievSet = get_field('achiev_2_set', get_option('page_on_front'));
?>
<? if(!empty($achievSet['achiev'])) { ?>
<section class="section-common colored <?=get_field('achiev_2_style', 'styleset')?> section-achiev section-achiev-2">
	<div class="container">
...
<div class="achiev_wrap <? if($achievCount > 4) { echo 'cur_achiev_wrap'; }?>">
    	<div class="achiev_row <? if($achievCount > 4) { echo 'cur_achiev_row_2'; } else { echo 'row'; } ?>">
