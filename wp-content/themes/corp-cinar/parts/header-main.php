...
<?php if($mhdc['main_header_data']): $i = 0;?>	
			...
			<? if($mhdcitem['object_type'] == 'contact_item') { ?>
				...
				<? } elseif($mhdcitem['object_type'] == 'modal_form_buttom') { ?>
					<a class="bl_header_button order_button datatextcopy" href="#fancy-modal-order-call" data-text="<?=$mhdcitem['button']['text']?>" data-fancybox="modal"><span><?=$mhdcitem['button']['text']?></span></a>
				<? } ?>	
				</div>
			<?php } ?>
<?php endif; ?>
