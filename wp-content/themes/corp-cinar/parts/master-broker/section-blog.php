...
if($showmode) {
	...
	<? 
	 foreach ($myposts as $mypost) {
		...
		get_template_part( 'parts/'.get_field('blog_select', get_option('page_on_front')).'/item/'.$itemTemplate, null, $params = ['content' => $mypost, 'col' => $col, 'labelTextMore' => $labelTextMore, 'openinmodal' => $openInModal, 'dateoption' => $cOption['vyvodit_datu']]);		
	 }
	?>	
	</div>	
	</div>	
